    ...
    <span class="navbar-toggler-icon"></span>
            ...
            <p>
                    <%
                        ...
                        %>
                        <h1 class="text-center text-white ">welcome,<%=session.getAttribute("login")%></h1>
        </p>
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item active">
        <a class="nav-link font-weight-bold" href="Login1.jsp" >LOGIN <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link font-weight-bold" href="process.jsp">LOGOUT</a>
      </li>
    </ul>
