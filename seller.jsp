        ...
        <form>
            <div class="form-row  ml-auto" >
                <div class="form-group col-md-6 ">
                    <label for="inputproductid">Seller Id</label>
                    <input type="text" class="form-control" id="sroid" placeholder="enter seller id" name="seller_id">
                </div>
                <div class="form-group col-md-6 ">
                    <label for="inputquntity">password</label>
                    <input type="password" class="form-control" id="pass"  name="s_pass">
                </div>
            </div>
            <form>
                <div class="form-row ml-auto">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="sname" placeholder="enter seller name" name="s_name">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Gender</label>
                ...
                <table class="table table-striped mt-6">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Seller Password</th>
